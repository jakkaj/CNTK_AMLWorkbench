...
if __name__ == '__main__':
    ...
    #savePath = os.path.join(os.path.dirname(os.path.abspath(__file__)), r"output.model")
   ...
   # jk_base_folder = os.path.dirname(os.path.abspath(__file__))
   # jk_up_folder =os.path.join(jk_base_folder, os.path.abspath(".."))


    # detect objects in single image
    #img_path = os.path.join(jk_up_folder, r"Signs/stopsign.jpg")
