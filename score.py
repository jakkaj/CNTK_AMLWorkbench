...
def do_detect(img_path, save_path):
    dl.downloadModel()
    ...
    return od.visualize_results(img_path, bboxes, labels, scores, cfg, save_path)
...
if __name__ == '__main__':
    save_path = os.path.abspath(os.path.join("outputs", "regions.png"))
    img_file = os.path.abspath(os.path.join(".", "owlie.jpg"))
    print(img_file)
    do_detect(img_file, save_path)
